...
main(int argc, char ** argv) 
{
  ...
  10:	2ea080e7          	jalr	746(ra) # 2f6 <fork>
  if(pid < 0) {
  14:	04054063          	bltz	a0,54 <main+0x54>
    printf("fork(): failed\n");
    exit(1);
  } else if(pid == 0) {
  18:	e939                	bnez	a0,6e <main+0x6e>
    trace(atoi(argv[1]));
  1a:	6488                	ld	a0,8(s1)
  1c:	00000097          	auipc	ra,0x0
  20:	1e8080e7          	jalr	488(ra) # 204 <atoi>
  24:	00000097          	auipc	ra,0x0
  28:	37a080e7          	jalr	890(ra) # 39e <trace>
    exec(argv[2], argv + 2);
  2c:	01048593          	addi	a1,s1,16
  30:	6888                	ld	a0,16(s1)
  32:	00000097          	auipc	ra,0x0
  36:	304080e7          	jalr	772(ra) # 336 <exec>
    printf("exec(): failed\n");
  3a:	00001517          	auipc	a0,0x1
  3e:	81650513          	addi	a0,a0,-2026 # 850 <malloc+0x100>
  42:	00000097          	auipc	ra,0x0
  46:	656080e7          	jalr	1622(ra) # 698 <printf>
    exit(1);
  4a:	4505                	li	a0,1
  4c:	00000097          	auipc	ra,0x0
  50:	2b2080e7          	jalr	690(ra) # 2fe <exit>
    printf("fork(): failed\n");
  54:	00000517          	auipc	a0,0x0
  58:	7ec50513          	addi	a0,a0,2028 # 840 <malloc+0xf0>
  5c:	00000097          	auipc	ra,0x0
  60:	63c080e7          	jalr	1596(ra) # 698 <printf>
    exit(1);
  64:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	4be50513          	addi	a0,a0,1214 # 8c0 <digits>
 40a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c6:	3a6c8c93          	addi	s9,s9,934 # 868 <malloc+0x118>
 ...
 4d4:	3f0b8b93          	addi	s7,s7,1008 # 8c0 <digits>
 ...
 5fa:	26a98993          	addi	s3,s3,618 # 860 <malloc+0x110>
        while(*s != 0){
 5fe:	85ee                	mv	a1,s11
